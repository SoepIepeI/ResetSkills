...
#* dont change size, they can also be used for controls that stretch
#* to match parent.
...
function AtLeftTopInZeroed(control, parent, leftOffset, topOffset)
    leftOffset = leftOffset or 0
    topOffset = topOffset or 0
    control.Left:Set(function() return math.floor(leftOffset) end)
    control.Top:Set(function() return math.floor(topOffset) end)
end
